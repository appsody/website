...
If you have modified files within `/image` you will need to [package](/content/docs/stacks/package.md) the stack to make sure its templates are working as intended.
