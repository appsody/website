...
| `.stack.image.namespace`  | The `image-namespace` from user defined image-namespace flag, default is `appsody`. |
| `.stack.image.registry`  | The `image-registry` from user defined image-registry flag, default is `dev.local`. |
