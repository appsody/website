    ...
    <section className="landing-section">
      ...
      <div className="container">
        <div id="application-stacks" className="row mx-auto">
          <Tile id="java-MicroProfile" heading="Java MicroProfile&reg;" desc="Microprofile using Adopt OpenJDK and Maven" cmd="appsody init java-microprofile" github="https://github.com/appsody/stacks/tree/master/incubator/java-microprofile"/>
