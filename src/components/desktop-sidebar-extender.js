...
const DesktopSidebarExtender = () => {
  function closeSidebar() {
      document.getElementById("sidebar").style.marginLeft= "-18.2em";
      ...
      document.getElementById("appsody-sidebar-header").style.marginLeft = "9.5em"; 
      document.getElementById("docs-sidebar-header").style.writingMode = "vertical-rl";
      document.getElementById("docs-sidebar-header").style.marginLeft = "9.5em"; 
  }
